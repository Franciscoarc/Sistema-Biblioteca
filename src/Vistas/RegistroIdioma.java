 ...
 * @author panch
 */
public class RegistroIdioma extends javax.swing.JFrame implements CRUD{
    ...
    private void initComponents() {
        ...
        txtIdioma = new javax.swing.JFormattedTextField();
        ...
        Titulo.setText("Registrar Idioma");
        jPanel1.add(Titulo);
        ...
        tablaIdioma.setCellSelectionEnabled(true);
        tablaIdioma.getTableHeader().setReorderingAllowed(false);
        tablaIdioma.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaIdiomaMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablaIdioma);
        tablaIdioma.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(70, 320, 640, 130);
        ...
        try {
            txtIdioma.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("????????????????")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        txtIdioma.setFocusLostBehavior(javax.swing.JFormattedTextField.PERSIST);
        jPanel1.add(txtIdioma);
        txtIdioma.setBounds(370, 90, 150, 20);
    ...
    private void tablaIdiomaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaIdiomaMouseClicked
        if (evt.getClickCount() == 2) {
            int filaSeleccionada = tablaIdioma.getSelectedRow();
            String idioma = tablaIdioma.getValueAt(filaSeleccionada, 0).toString();
            modificar = tablaIdioma.getValueAt(filaSeleccionada, 0).toString();

            txtIdioma.setText(idioma);
        }
    }//GEN-LAST:event_tablaIdiomaMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroIdioma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroIdioma().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField txtIdioma;
    ...
    public void modificar() {
        try {
            ...
            String sql = "UPDATE Idioma SET IDIOMA='" + nombre + "' WHERE IDIOMA ='" + modificar + "'";
    ...
    public void insertar() {
        try {
            ...
            String idio = txtIdioma.getText().trim();
            ps = con.prepareStatement(sql);
            ps.setString(1, txtIdioma.getText().trim());
            int res = ps.executeUpdate();
            if (res > 0) {
            ...
            if (txtIdioma.getText().trim().length() == 0 || txtIdioma.getText().trim().equals("")) {
                JOptionPane.showMessageDialog(null, "No se ingresó Idioma", "Mensaje de Error", JOptionPane.ERROR_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "No se ha ingresado correctamente a la BD, el Idioma ya se encuentra Ingresado", "Mensaje de Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void eliminar() {
        ...
        filaseleccionada = tablaIdioma.getSelectedRow();
        if (filaseleccionada >= 0) {
            try {
                ...
                if (seleccionar == 0) {
                    String sql = "DELETE FROM Idioma WHERE IDIOMA = ?";
                    String valor = tablaIdioma.getValueAt(filaseleccionada, 0).toString();
                    ps = con.prepareStatement(sql);
    ...
    public void buscarPor() {
        ...
        try {
            ...
            if (buscar.equals("")) {
                ...
                String sql = "SELECT * FROM Idioma WHERE UPPER(IDIOMA)  like UPPER('%" + buscar + "%') ";
                ps = con.prepareStatement(sql);
                rs = ps.executeQuery();
                ResultSetMetaData rsmd = rs.getMetaData();
                int cantColumnas = rsmd.getColumnCount();
