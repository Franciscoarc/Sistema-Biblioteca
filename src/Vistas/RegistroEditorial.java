 ...
 * @author panch
 */
public class RegistroEditorial extends javax.swing.JFrame implements CRUD {
    ...
    private void initComponents() {
        ...
        Titulo.setText("Registrar Editorial");
        jPanel1.add(Titulo);
        Titulo.setBounds(270, 20, 300, 30);
        ...
        lblCategoria.setBounds(280, 90, 100, 20);
        jPanel1.add(txtNombreEditorial);
        txtNombreEditorial.setBounds(380, 90, 130, 20);
        ...
        tablaEditorial.setBackground(new java.awt.Color(0, 204, 255));
        ...
        tablaEditorial.setCellSelectionEnabled(true);
        ...
        tablaEditorial.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
    ...
    private void tablaEditorialMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaEditorialMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            String nombre = tablaEditorial.getValueAt(filaSeleccionada, 0).toString();
            modificar = tablaEditorial.getValueAt(filaSeleccionada, 0).toString();
    ...
    public void modificar() {
        try {
            ...
            String sql = "UPDATE Editorial SET NOMBRE_EDITORIAL='" + nombre + "' WHERE NOMBRE_EDITORIAL ='" + modificar + "'";
    ...
    public void insertar() {
        try {
            ...
            ps = con.prepareStatement(sql);
            ps.setString(1, txtNombreEditorial.getText().trim());
            int res = ps.executeUpdate();
            if (res > 0) {
            ...
            if (txtNombreEditorial.getText().trim().length() == 0 || txtNombreEditorial.getText().trim().equals("")) {
                JOptionPane.showMessageDialog(null, "No se ingresó Editorial", "Mensaje de Error", JOptionPane.ERROR_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "Ya se ha ingresado esta Editorial", "Mensaje de Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void eliminar() {
        ...
        filaseleccionada = tablaEditorial.getSelectedRow();
        if (filaseleccionada >= 0) {
            try {
                ...
                if (seleccionar == 0) {
                    String sql = "DELETE FROM Editorial WHERE NOMBRE_EDITORIAL = ?";
                    String valor = tablaEditorial.getValueAt(filaseleccionada, 0).toString();
                    ps = con.prepareStatement(sql);
    ...
    public void buscarPor() {
        ...
        try {
            ...
            if (buscar.equals("")) {
                ...
                String sql = "SELECT * FROM Editorial WHERE UPPER(NOMBRE_EDITORIAL)  like UPPER('%" + buscar + "%') ";
                ps = con.prepareStatement(sql);
                rs = ps.executeQuery();
                ResultSetMetaData rsmd = rs.getMetaData();
                int cantColumnas = rsmd.getColumnCount();
