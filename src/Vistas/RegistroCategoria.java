 ...
 * @author panch
 */
public class RegistroCategoria extends javax.swing.JFrame implements CRUD {
    ...
    private void initComponents() {
        ...
        Titulo.setText("Registro de Categoría");
        jPanel1.add(Titulo);
        ...
        tablaCategoria.setBackground(new java.awt.Color(0, 204, 255));
        ...
        tablaCategoria.setCellSelectionEnabled(true);
        ...
        tablaCategoria.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
        ...
        lblBusqueda.setBounds(380, 280, 80, 20);
        jPanel1.add(txtBusqueda);
        txtBusqueda.setBounds(470, 280, 140, 20);
        ...
        txtCategoria.setFocusLostBehavior(javax.swing.JFormattedTextField.PERSIST);
        jPanel1.add(txtCategoria);
        txtCategoria.setBounds(370, 90, 130, 20);
    ...
    private void tablaCategoriaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaCategoriaMouseClicked
       if(evt.getClickCount() == 2){
           ...
           String tipo = tablaCategoria.getValueAt(filaSeleccionada, 0).toString();
            modificar = tablaCategoria.getValueAt(filaSeleccionada, 0).toString();
    ...
    public void modificar() {
        try {
            String tipo = txtCategoria.getText().trim();
            String sql = "UPDATE Categoria SET TIPO='"+tipo+"' WHERE TIPO ='" + modificar + "'";
    ...
    public void insertar() {
        try {
            ...
            ps = con.prepareStatement(sql);
            ps.setString(1, txtCategoria.getText().trim());
            int res = ps.executeUpdate();
            if (res > 0) {
            ...
            if (txtCategoria.getText().trim().length() == 0 || txtCategoria.getText().trim().equals("")) {
                JOptionPane.showMessageDialog(null, "No se ingresó Categoria", "Mensaje de Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
        ...
        if (filaseleccionada >= 0) {
            try {
                ...
                if (seleccionar == 0) {
                    ...
                    String valor = tablaCategoria.getValueAt(filaseleccionada, 0).toString();
                    ps = con.prepareStatement(sql);
    ...
    public void buscarPor() {
        ...
        try {
            ...
            if (buscar.equals("")) {
                ...
                String sql = "SELECT * FROM Categoria WHERE  UPPER(TIPO)  like UPPER('%" + buscar + "%') ";
                ps = con.prepareStatement(sql);
                rs = ps.executeQuery();
                ResultSetMetaData rsmd = rs.getMetaData();
                int cantColumnas = rsmd.getColumnCount();
